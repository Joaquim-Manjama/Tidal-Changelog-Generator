...
const SideBar = () => {
    return <div className="absolute border-r-2 border-gray-500 w-[220px] h-screen top-0 left-0 flex flex-col bg-ink-black-950">
        <h1 className="text-3xl font-normal p-5">Tidal</h1>
        <button className={`${optionStyle} border-t-2 border-gray-500 rounded-t-none`}>
