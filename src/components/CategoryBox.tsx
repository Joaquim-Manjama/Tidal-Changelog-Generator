...
const CategoryBox = ({ categoryType, onAddEntry }: CategoryBoxProps) => {
    ...
    return <div className="flex flex-col bg-white/2 backdrop-blur-xl border border-white/2 rounded shadow-xl mt-5">
                <div className="p-4 border-b border-white/2 flex justify-between">
                    ...
                    <button onClick={() => onAddEntry(categoryType)} className="text-ocean-blue-300 font-thin bg-white/2 backdrop-blur-xl border border-white/2 p-2 pl-4 pr-4 rounded hover:cursor-pointer hover:text-ocean-blue-400 ">+ Add {getButtonName(categoryType)}</button>
                </div>
